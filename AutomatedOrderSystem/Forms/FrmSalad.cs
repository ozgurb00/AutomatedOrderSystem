...
{
    public partial class FrmSalad : Form
    {
        public FrmSalad()
        {
            InitializeComponent();
        ...
        private void FrmSalad_Load(object sender, EventArgs e)
        {
            FoodManager fm = new FoodManager();
            GridSalad.DataSource = (from x in fm.GetAll()
                                   select new
                                   {
                                       x.FoodID,
                                       x.FoodName,
