...
{
    public partial class FrmFries : Form
    {
        public FrmFries()
        {
            InitializeComponent();
        ...
        private void FrmFries_Load(object sender, EventArgs e)
        {
            FoodManager fm = new FoodManager();
            GridFries.DataSource = (from x in fm.GetAll()
                                   select new
                                   {
                                       x.FoodID,
                                       x.FoodName,
